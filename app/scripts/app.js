...
(function() {
  ...
  define(['jquery', 'stellar', 'autosize'], function($) {
    ...
    return $(document).ready(function() {
      var isMobileWebkit, resizeInput, ua;
      $('a[href="#design"],\
			a[href="#development"],\
			a[href="#education"],\
			a[href="#contact-me"],\
      ...
      $("#contact-type").change(function() {
        switch ($(this).val()) {
          case "texting":
          case "calling":
            return $("#contact-info").prop("placeholder", "312 865 5309");
          case "yodeling to":
            return $("#contact-info").prop("placeholder", "my address in the Himalayas");
          default:
            return $("#contact-info").prop("placeholder", "joe@example.com");
        }
      });
      $('textarea').autosize();
      ...
      return $("#send-form").submit(function(e) {
        ...
        html = "				<h1>New Message on EricCecchi.com</h1>				<p>				" + from_name + " sent you a message on " + date + ". " + first_name + " wanted to " + ($('#message-type').val()) + " about				 " + ($('#message-topic').val()) + "				</p>				<p>				" + ($('#message').val()) + "				</p>				<p>				You can contact " + first_name + " by " + contact_type + " them at " + from_email + ".				</p>				";
